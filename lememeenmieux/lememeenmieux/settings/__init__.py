"""
Django settings for lememeenmieux project.
...
SECRET_KEY = 's!$g3422sh0-f%cak8)$^^i_o2h3jg3kjip!&w@c=c0omtj!cm'
...
#Commented because doesn't work for hosting without heroku
